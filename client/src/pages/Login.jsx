  ...
  return (
    ...
    px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400'>
      ...
      sm:w-96 text-indigo-300 text-sm'>
        ...
        <p className='text-center text-sm mb-5'>{state==='Sign Up' ? 'create your account':'login to your account'}</p>
        <form onSubmit={onSubmitHandler}>
            ...
            <p onClick={()=>navigate('/reset-password')} className='mb-4 text-indigo-500 cursor-pointer'>Forget Passowrd</p>
